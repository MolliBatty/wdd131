...
const a = 5; 
// const variable called a is set to 5 which is an interger
const b = true;
// declared variable to boolean
const reg = /\d{2}/;
// regular expression 
// digit that has to be a number, has to have 2 digits - ^ start of string - $ end of string (exactly 2 digits)